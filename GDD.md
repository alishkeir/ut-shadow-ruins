...
- **Phase 1:**
  - <input type="checkbox"/> Build 2D character controller.
  - <input type="checkbox"/> Implement movement mechanics:
    - <input type="checkbox"/> Variable jump height
    - <input type="checkbox"/> Coyote time
    - <input type="checkbox"/> Jump buffering
    - <input type="checkbox"/> Roll
    - <input type="checkbox"/> Dash

- **Phase 2:**
  - [x] Create sword combat system.
  - <input type="checkbox"/> Implement:
    - <input type="checkbox"/> Four-hit combo
    - <input type="checkbox"/> Shield Bash
    - <input type="checkbox"/> Hit detection
    - <input type="checkbox"/> Damage system
    - <input type="checkbox"/> Enemy reactions

- <input type="checkbox"/> **Phase 3:**
  - <input type="checkbox"/> Build enemy AI systems.
  - <input type="checkbox"/> Implement:
    - <input type="checkbox"/> Bush Monster
    - <input type="checkbox"/> White Skeleton
    - <input type="checkbox"/> Golden Skeleton
    - <input type="checkbox"/> AI state machines

- **Phase 4:**
  - <input type="checkbox"/> Create boss arena.
  - <input type="checkbox"/> Implement:
    - <input type="checkbox"/> Guardian boss
    - <input type="checkbox"/> Checkpoints
    - <input type="checkbox"/> Save system
    - <input type="checkbox"/> Final polish
